<template>
  <div v-if="isactive" class="Overview">
    <h2>Overview</h2>
    <FormText @valueChanged="formValueChanged" title="Name" name="name" description="What's The Name Of Your Character?" v-bind:value="nameValue" linkable="true" />
    <FormText @valueChanged="formValueChanged" title="Bio" name="bio" description="Write a Short Bio About This Character?" v-bind:value="bioValue" largeField="true" linkable="true" searchEntities="character,creature,region,city,pointofinterest,religion,language,spell,item,planet,technology"/>
