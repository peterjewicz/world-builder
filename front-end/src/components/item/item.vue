<template>
  <div class="Creature">
    ...
    <button class="primary large saveButton" v-on:click="addEntity">Save Item!</button>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.id) {
      ...
      this.historyValues = currentItem[0].value.history;
      this.completeValues.history = {...currentItem[0].value.physical};

      this.mediaValue = currentItem[0].value.media;
