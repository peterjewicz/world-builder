<template>
  <div v-if="isactive" class="Overview">
    <h2>Overview</h2>
    <FormText @valueChanged="formValueChanged" title="Name" description="What's The Name Of This Religion?" v-bind:value="nameValue" />
    <FormText @valueChanged="formValueChanged" title="Location" description="Where is it Practiced?" v-bind:value="locationValue" />
  </div>
</template>
