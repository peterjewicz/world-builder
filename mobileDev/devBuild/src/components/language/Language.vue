...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.id) {
      ...
      this.historyValues = currentLanguage[0].value.history;
      this.completeValues.history = {...currentLanguage[0].value.physical};

      this.mediaValue = currentLanguage[0].value.media;
